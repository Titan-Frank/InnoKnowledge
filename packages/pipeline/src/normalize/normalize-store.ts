  ...
  const statements: SqlStatement[] = [
    {
      ...
      sql: [
        ...
        "dataset_id, id, node_id, domain, schema_id, schema_version, domain_role, source_refs_json, properties_json, status, created_at, updated_at, notes",
      ...
      params: [
        ...
        group.key.node_id,
        group.key.domain,
        group.merged.schema_id,
        group.merged.schema_version,
        group.merged.domain_role,
